...
def lstm_model_categorical_data_concat():
    ...
    df_test['sequence_cats_level1'] = [ast.literal_eval(cat_list_string) for cat_list_string in df_test['sequence_cats_level1']]
    ...
    df_test['sequence_cats_level2'] = [ast.literal_eval(cat_list_string) for cat_list_string in df_test['sequence_cats_level2']]
    ...
    df_test['sequence_events'] = [ast.literal_eval(event_list_string) for event_list_string in df_test['sequence_events']]
    ...
    def build_model(X_t, y_t, X_v, y_v, units, dropout, epochs, opt, loss, title):
        ...
        #plt.show()'''
    print("++++++++++++++++++++++++++++++++++++++++++++++++")
    build_model(X_train, y_train, X_val, y_val, 70, 0, 100, 'adam', 'standard', 'standard categorical crossentropy loss')
    print("++++++++++++++++++++++++++++++++++++++++++++++++")
...
def lstm_model_categorical_data_first_l2():
    ...
    '''
    print("++++++++++++++++++++++++++++++++++++++++++++++++")
    build_model(X_train, y_train, X_val, y_val, 90, 0.4, 150, 'adagrad', 'standard',
                'standard categorical accuracy keras')
    print("++++++++++++++++++++++++++++++++++++++++++++++++")
    build_model(X_train, y_train, X_val, y_val, 70, 0.4, 150, 'adagrad', 'custom',
                'standard categorical accuracy keras')
